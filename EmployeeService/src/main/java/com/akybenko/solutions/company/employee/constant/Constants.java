package com.akybenko.solutions.company.employee.constant;

public class Constants {

    public interface Swagger {
        String APP_INFO_TITLE = "Employee API documentation";
        String APP_INFO_DESCRIPTION = "Employee API documentation";
        ...
        String BASE_PACKAGE = "com.akybenko.solutions.company.employee.controller";

        String AUTHORIZATION_PARAMETER_NAME = "Authorization";
        String AUTHORIZATION_PARAMETER_TYPE = "string";
        String AUTHORIZATION_PARAMETER_PARAMETER_TYPE = "header";
        boolean AUTHORIZATION_PARAMETER_REQUIRED = true;
    }
}
